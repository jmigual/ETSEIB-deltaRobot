...
/// @brief The XJoystick's class is used to control the SFML Joystick's class 
/// with <em>signals and slots</em>
class XJoystick : public QObject
{
    Q_OBJECT
...
public:
    ...
    /// Returns the current selected joystick, -1 if there's no selected 
    /// joystick
