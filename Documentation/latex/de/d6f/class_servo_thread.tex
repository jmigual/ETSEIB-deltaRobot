...
\begin{DoxyCompactItemize}
\item 
double \hyperlink{class_servo_thread_a5254b08335f14de98d18aed01abc6f58}{cos60} = 0.\+5
...
\begin{DoxyCode}
00027     \{
00028         \hyperlink{class_servo_thread_aeccce0ac6a969e2ee7cbe91687e2d085a319b6bf2cb120faeefbd0a5118ece7e3}{v\_1\_0}
00029     \};
\end{DoxyCode}
...
\begin{DoxyCode}
00114 \{    
00115     \textcolor{keywordtype}{double} x1 = x0 + \hyperlink{class_servo_thread_a3d51c16b1f498b48a6ecbfaadaba6ed2}{L2} - \hyperlink{class_servo_thread_a6281142e50115dd8c914c14cfae6f90d}{L1};
00116     \textcolor{keywordtype}{double} y1 = y0;
00117     \textcolor{keywordtype}{double} z1 = z0;
00118     theta1 = \hyperlink{class_servo_thread_add4637d917a772c4c01a43b5b66da2be}{singleAngle}(x1,y1,z1);
00119     
00120     \textcolor{keywordtype}{double} x2 = z0*\hyperlink{class_servo_thread_addbe4545236e5ded8c4956f2e2d52a84}{sin60} - x0*\hyperlink{class_servo_thread_a5254b08335f14de98d18aed01abc6f58}{cos60} + \hyperlink{class_servo_thread_a3d51c16b1f498b48a6ecbfaadaba6ed2}{L2} - \hyperlink{class_servo_thread_a6281142e50115dd8c914c14cfae6f90d}{L1};
00121     \textcolor{keywordtype}{double} y2 = y0;
00122     \textcolor{keywordtype}{double} z2 = -z0*\hyperlink{class_servo_thread_a5254b08335f14de98d18aed01abc6f58}{cos60} - x0*\hyperlink{class_servo_thread_addbe4545236e5ded8c4956f2e2d52a84}{sin60};
00123     theta2 = \hyperlink{class_servo_thread_add4637d917a772c4c01a43b5b66da2be}{singleAngle}(x2,y2,z2);
00124     
00125     \textcolor{keywordtype}{double} x3 = -z0*sin60 - x0*\hyperlink{class_servo_thread_a5254b08335f14de98d18aed01abc6f58}{cos60} + \hyperlink{class_servo_thread_a3d51c16b1f498b48a6ecbfaadaba6ed2}{L2} - \hyperlink{class_servo_thread_a6281142e50115dd8c914c14cfae6f90d}{L1};
00126     \textcolor{keywordtype}{double} y3 = y0;
00127     \textcolor{keywordtype}{double} z3 = -z0*\hyperlink{class_servo_thread_a5254b08335f14de98d18aed01abc6f58}{cos60} + x0*\hyperlink{class_servo_thread_addbe4545236e5ded8c4956f2e2d52a84}{sin60};
00128     theta3 = \hyperlink{class_servo_thread_add4637d917a772c4c01a43b5b66da2be}{singleAngle}(x3,y3,z3);
00129 \}
\end{DoxyCode}
...
00134     \textcolor{keywordtype}{double} raiz = sqrt (n*n*y0*y0 - 4*(x0*x0 + y0*y0)*(-x0*x0*\hyperlink{class_servo_thread_a7dc3998d380d61406fe4485f9872edff}{a}*\hyperlink{class_servo_thread_a7dc3998d380d61406fe4485f9872edff}{a} + n*n/4));
00135     
00136     \textcolor{keywordflow}{if} (x0 < 0) raiz *= -1;
00137     \textcolor{keywordtype}{double} y = (-n*y0 + raiz ) / (2*(x0*x0 + y0*y0));
00138     
00139     \textcolor{keywordtype}{int} signe = 1;
00140     \textcolor{keywordflow}{if} ((\hyperlink{class_servo_thread_a14f03febaa39a60b9bf7ff9b9151060c}{b}*\hyperlink{class_servo_thread_a14f03febaa39a60b9bf7ff9b9151060c}{b} - (y0 + \hyperlink{class_servo_thread_a7dc3998d380d61406fe4485f9872edff}{a})*(y0 + \hyperlink{class_servo_thread_a7dc3998d380d61406fe4485f9872edff}{a})) < (x0*x0 + z0*z0) && x0 < 0) signe *= -1;
00141     \textcolor{keywordtype}{double} x = sqrt(\hyperlink{class_servo_thread_a7dc3998d380d61406fe4485f9872edff}{a}*\hyperlink{class_servo_thread_a7dc3998d380d61406fe4485f9872edff}{a} - y*y)*signe;
00142     \textcolor{keywordflow}{return} atan2 (y,x);
00143 \}
\end{DoxyCode}
...
\hypertarget{class_servo_thread_a5254b08335f14de98d18aed01abc6f58}{}\index{Servo\+Thread@{Servo\+Thread}!cos60@{cos60}}
\index{cos60@{cos60}!Servo\+Thread@{Servo\+Thread}}
\subsubsection[{cos60}]{\setlength{\rightskip}{0pt plus 5cm}double Servo\+Thread\+::cos60 = 0.\+5\hspace{0.3cm}{\ttfamily [private]}}\label{class_servo_thread_a5254b08335f14de98d18aed01abc6f58}
...
\hypertarget{class_servo_thread_addbe4545236e5ded8c4956f2e2d52a84}{}\index{Servo\+Thread@{Servo\+Thread}!sin60@{sin60}}
