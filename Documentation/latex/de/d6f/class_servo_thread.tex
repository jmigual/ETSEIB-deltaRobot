...
\begin{DoxyCode}
00051     \{
00052         \hyperlink{class_servo_thread_a8d581034e60792a9995d44065f6140a5a6776147f492a4e0b0bb5ee4fdbc8d086}{controlled},
00053         \hyperlink{class_servo_thread_a8d581034e60792a9995d44065f6140a5ae260aa6159d95b94851c96df939b51b3}{manual}
00054     \};
\end{DoxyCode}
...
\begin{DoxyCode}
00028     \{
00029         \hyperlink{class_servo_thread_aeccce0ac6a969e2ee7cbe91687e2d085a319b6bf2cb120faeefbd0a5118ece7e3}{v\_1\_0}
00030     \};
\end{DoxyCode}
...
00017     \hyperlink{class_servo_thread_ab03428f82ff9343dbbca155a91908c0a}{\_statusBar}(NULL)
00018 \{
00019     
00020 \}
\end{DoxyCode}
...
\begin{DoxyCode}
00023 \{
00024     \hyperlink{class_servo_thread_a6327eafc0dac189ec1b202d63ef32457}{\_mutex}.lock();
00025     \hyperlink{class_servo_thread_acca9896d1a2d1ef68527e6834f81c76c}{\_end} = \textcolor{keyword}{true};
00026     \hyperlink{class_servo_thread_afcb93c09acd7fecf47d92996a297365c}{\_cond}.wakeOne();
00027     \hyperlink{class_servo_thread_a6327eafc0dac189ec1b202d63ef32457}{\_mutex}.unlock();
00028     
00029     wait();
00030 \}
\end{DoxyCode}
...
\begin{DoxyCode}
00033 \{
00034     \hyperlink{class_servo_thread_a6327eafc0dac189ec1b202d63ef32457}{\_mutex}.lock();
00035     QFile f(file);
...
00043         df >> \hyperlink{class_servo_thread_a9fccfd415e2e55c8abef7fcc6535af30}{\_cBaud} >> \hyperlink{class_servo_thread_ab52437b31a433c427a6c050f2b1cc959}{\_cPort} >> \hyperlink{class_servo_thread_a5b9a41b9e271275b914affb0a845a2ee}{\_sBaud} >> \hyperlink{class_servo_thread_ac9a614aa1518efb49b0a06636bd1bdbf}{\_sPort} >> n;
00044         
00045         \hyperlink{class_servo_thread_a1ac6662fe6d198b5971ae0ffa7ddfcfd}{\_servos}.resize(n);
00046         \textcolor{keywordflow}{for} (Servo &s : \hyperlink{class_servo_thread_a1ac6662fe6d198b5971ae0ffa7ddfcfd}{\_servos}) df >> s.ID;
00047         \hyperlink{class_servo_thread_a2b6ccfeacbb3cc9ac5c34549b9aa3f11}{\_dChanged} = \textcolor{keyword}{true};
00048     \}
00049     \textcolor{keywordflow}{else} qWarning() << \textcolor{stringliteral}{"Not a valid file"};    
00050     \hyperlink{class_servo_thread_a6327eafc0dac189ec1b202d63ef32457}{\_mutex}.unlock();
00051 \}
\end{DoxyCode}
...
\begin{DoxyCode}
00125 \{ \textcolor{keywordflow}{return} &\hyperlink{class_servo_thread_a6327eafc0dac189ec1b202d63ef32457}{\_mutex}; \}
\end{DoxyCode}
...
\begin{DoxyCode}
00079 \{
00080     \hyperlink{class_servo_thread_a6327eafc0dac189ec1b202d63ef32457}{\_mutex}.lock();
00081     \textcolor{keywordtype}{int} sBaud = \hyperlink{class_servo_thread_a5b9a41b9e271275b914affb0a845a2ee}{\_sBaud};
00082     QString sPort = \hyperlink{class_servo_thread_ac9a614aa1518efb49b0a06636bd1bdbf}{\_sPort};
00083     
00084     \hyperlink{class_servo_thread_a6327eafc0dac189ec1b202d63ef32457}{\_mutex}.unlock();
00085     \hyperlink{classdynamixel}{dynamixel} dxl(sPort, sBaud);
00086     QVector< AX12 > (\hyperlink{class_servo_thread_a1ac6662fe6d198b5971ae0ffa7ddfcfd}{\_servos}.size(), &dxl);
00087     
00088     \textcolor{keywordflow}{while} (not \hyperlink{class_servo_thread_acca9896d1a2d1ef68527e6834f81c76c}{\_end}) \{
00089         
00090         msleep(10);
00091         \hyperlink{class_servo_thread_a6327eafc0dac189ec1b202d63ef32457}{\_mutex}.lock();
00092         \textcolor{keywordflow}{if} (not \_end and \hyperlink{class_servo_thread_aaf2ef80e8e43518b75d20a5102970d2e}{\_pause}) \{
00093             dxl.terminate();
00094             \hyperlink{class_servo_thread_afcb93c09acd7fecf47d92996a297365c}{\_cond}.wait(&\hyperlink{class_servo_thread_a6327eafc0dac189ec1b202d63ef32457}{\_mutex});
...
\begin{DoxyCode}
00054 \{
00055     \hyperlink{class_servo_thread_a6327eafc0dac189ec1b202d63ef32457}{\_mutex}.lock();
00056     \textcolor{comment}{// Copying the joystick values}
00057     \hyperlink{class_servo_thread_aad24ef961ee39dd35766c725c13b11b7}{\_axis} = aV;
00058     \hyperlink{class_servo_thread_a6f956f7e0f2953e213ff95fb64857ab0}{\_buts} = buts;
00059     \hyperlink{class_servo_thread_a2b6ccfeacbb3cc9ac5c34549b9aa3f11}{\_dChanged} = \textcolor{keyword}{true};
00060     
00061     \hyperlink{class_servo_thread_a6327eafc0dac189ec1b202d63ef32457}{\_mutex}.unlock();
00062 \}
\end{DoxyCode}
...
00171     \}
\end{DoxyCode}
\hypertarget{class_servo_thread_a2d05e011577cf2783978a9837114e29e}{}\index{Servo\+Thread@{Servo\+Thread}!set\+Status\+Bar@{set\+Status\+Bar}}
\index{set\+Status\+Bar@{set\+Status\+Bar}!Servo\+Thread@{Servo\+Thread}}
\subsubsection[{set\+Status\+Bar}]{\setlength{\rightskip}{0pt plus 5cm}void Servo\+Thread\+::set\+Status\+Bar (
\begin{DoxyParamCaption}
\item[{Q\+Status\+Bar $\ast$}]{status}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}}\label{class_servo_thread_a2d05e011577cf2783978a9837114e29e}
...
\begin{DoxyParams}{Parameters}
{\em status} & Pointer to the status bar \\
\hline
\end{DoxyParams}
...
\begin{DoxyCode}
00065 \{
00066     \hyperlink{class_servo_thread_a6327eafc0dac189ec1b202d63ef32457}{\_mutex}.lock();
00067     QFile f(file);
00068     f.open(QIODevice::WriteOnly);
00069     QDataStream df(&f);
00070     
00071     df << int(Version::v\_1\_0) << \hyperlink{class_servo_thread_a9fccfd415e2e55c8abef7fcc6535af30}{\_cBaud} << \hyperlink{class_servo_thread_ab52437b31a433c427a6c050f2b1cc959}{\_cPort} << \hyperlink{class_servo_thread_a5b9a41b9e271275b914affb0a845a2ee}{\_sBaud} << 
      \hyperlink{class_servo_thread_ac9a614aa1518efb49b0a06636bd1bdbf}{\_sPort}
00072        << \hyperlink{class_servo_thread_a1ac6662fe6d198b5971ae0ffa7ddfcfd}{\_servos}.size();    
00073     \textcolor{keywordflow}{for} (\textcolor{keyword}{const} Servo &s : \hyperlink{class_servo_thread_a1ac6662fe6d198b5971ae0ffa7ddfcfd}{\_servos}) df << s.ID;
00074     
...
\hypertarget{class_servo_thread_ab03428f82ff9343dbbca155a91908c0a}{}\index{Servo\+Thread@{Servo\+Thread}!\+\_\+status\+Bar@{\+\_\+status\+Bar}}
\index{\+\_\+status\+Bar@{\+\_\+status\+Bar}!Servo\+Thread@{Servo\+Thread}}
