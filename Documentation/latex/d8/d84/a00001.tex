...
\subsubsection[{set\+Compliance\+Slope}]{\setlength{\rightskip}{0pt plus 5cm}void A\+X12\+::set\+Compliance\+Slope (
\begin{DoxyParamCaption}
\item[{uchar}]{ccw, }
\item[{uchar}]{cw}
\end{DoxyParamCaption}
...
\subsubsection[{set\+Radians}]{\setlength{\rightskip}{0pt plus 5cm}void A\+X12\+::set\+Radians (
\begin{DoxyParamCaption}
\item[{bool}]{rads}
\end{DoxyParamCaption}
