\hypertarget{a00009}{}\section{Servo\+Thread Class Reference}
...
const double \hyperlink{a00009_a7dc3998d380d61406fe4485f9872edff}{a} = 17.\+233
...
const double \hyperlink{a00009_a6281142e50115dd8c914c14cfae6f90d}{L1} = 6.\+374
...
Q\+Vector4\+D \hyperlink{a00009_a232fd9d19e8f1be1d42b5801460137c6}{pos\+Start} = Q\+Vector4\+D(11.\+5, 0.\+0f, -\/20, 150)
...
double \hyperlink{a00009_a86b38e336a177d6dd31401af98b07172}{work\+Heigh} = -\/25.\+0
...
\subsubsection[{Status}]{\setlength{\rightskip}{0pt plus 5cm}enum {\bf Servo\+Thread\+::\+Status}\hspace{0.3cm}{\ttfamily [private]}}\label{a00009_a3c23985ab5e94c14f5e6fca0a9338f9c}
...
\subsubsection[{Version}]{\setlength{\rightskip}{0pt plus 5cm}enum {\bf Servo\+Thread\+::\+Version}\hspace{0.3cm}{\ttfamily [private]}}\label{a00009_aeccce0ac6a969e2ee7cbe91687e2d085}
...
00017     \hyperlink{a00009_a2591c704c80518be7abb1698364cab5e}{\_sSpeed}(30),
...
\subsubsection[{get\+Current\+Pos}]{\setlength{\rightskip}{0pt plus 5cm}Q\+Vector4\+D Servo\+Thread\+::get\+Current\+Pos (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{get\+Servos\+Num}]{\setlength{\rightskip}{0pt plus 5cm}int Servo\+Thread\+::get\+Servos\+Num (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{get\+Speed}]{\setlength{\rightskip}{0pt plus 5cm}int Servo\+Thread\+::get\+Speed (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
\subsubsection[{is\+Active}]{\setlength{\rightskip}{0pt plus 5cm}bool Servo\+Thread\+::is\+Active (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
00179     \}
\end{DoxyCode}
\hypertarget{a00009_a85e5ae874d5e877b94a4a1cc78fe9598}{}\index{Servo\+Thread@{Servo\+Thread}!is\+Pos\+Available@{is\+Pos\+Available}}
\index{is\+Pos\+Available@{is\+Pos\+Available}!Servo\+Thread@{Servo\+Thread}}
\subsubsection[{is\+Pos\+Available}]{\setlength{\rightskip}{0pt plus 5cm}bool Servo\+Thread\+::is\+Pos\+Available (
\begin{DoxyParamCaption}
\item[{const Q\+Vector$<$ {\bf Servo} $>$ \&}]{S, }
\item[{const Q\+Vector$<$ double $>$ \&}]{D, }
\item[{const Q\+Vector3\+D \&}]{new\+Pos, }
\item[{double}]{err}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [private]}}\label{a00009_a85e5ae874d5e877b94a4a1cc78fe9598}
...
\begin{DoxyCode}
00132 \{
00133     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; i < 3; ++i) \{
00134         \textcolor{keywordtype}{double} aux = abs(S[i].pos - D[i]);
00135         \textcolor{keywordflow}{if} (aux > err) \textcolor{keywordflow}{return} \textcolor{keyword}{false};
00136     \}
00137     
00138     \textcolor{keywordflow}{if} (newPos.toVector2D().lengthSquared() > \hyperlink{a00009_a4b9e5de00a02c6f77e4308ed209f0cc0}{workRadSq}) \textcolor{keywordflow}{return} \textcolor{keyword}{false};
00139     
00140     QVector<double> theta(3);
00141     this->\hyperlink{a00009_a2b9f97473d19a7defaed3451bc830f79}{setAngles}(newPos, theta);
00142     
00143     \textcolor{keywordflow}{for} (\textcolor{keyword}{const} \textcolor{keywordtype}{double} &d : theta) \{
00144         \textcolor{keywordflow}{if} (qIsNaN(d)) \textcolor{keywordflow}{return} \textcolor{keyword}{false};
00145         \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (d > \hyperlink{a00009_a77cc2aed4eff12967e346cb64f6be192}{maxAngle} or d < \hyperlink{a00009_a9af4e0214b1b5c64978bbef49cde6d3c}{minAngle}) \textcolor{keywordflow}{return} \textcolor{keyword}{false};
00146     \}
00147     
00148     \textcolor{keywordflow}{return} \textcolor{keyword}{true};
00149 \}
\end{DoxyCode}
\hypertarget{a00009_a7a58c195c66f7d668b9344b82c7ac631}{}\index{Servo\+Thread@{Servo\+Thread}!is\+Ready@{is\+Ready}}
\index{is\+Ready@{is\+Ready}!Servo\+Thread@{Servo\+Thread}}
\subsubsection[{is\+Ready}]{\setlength{\rightskip}{0pt plus 5cm}bool Servo\+Thread\+::is\+Ready (
\begin{DoxyParamCaption}
\item[{const Q\+Vector$<$ {\bf Servo} $>$ \&}]{S, }
\item[{const Q\+Vector3\+D \&}]{pos, }
\item[{double}]{err}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [private]}}\label{a00009_a7a58c195c66f7d668b9344b82c7ac631}

\begin{DoxyCode}
00153 \{
00154     QVector<double> D(3);
00155     this->\hyperlink{a00009_a2b9f97473d19a7defaed3451bc830f79}{setAngles}(pos, D);
00156     
00157     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; i < 3; ++i) \{
00158         \textcolor{keywordtype}{double} aux = abs(S[i].pos - D[i]);
00159         \textcolor{keywordflow}{if} (aux > err) \textcolor{keywordflow}{return} \textcolor{keyword}{false};
00160     \}
...
\subsubsection[{mode\+Changed}]{\setlength{\rightskip}{0pt plus 5cm}void Servo\+Thread\+::mode\+Changed (
\begin{DoxyParamCaption}
\item[{{\bf Mode}}]{}
\end{DoxyParamCaption}
...
00037         emit \hyperlink{a00009_a3c84cf179d1746091795c60f3a68ce06}{statusBar}(\textcolor{stringliteral}{"Cannot read stored data"});
...
00047         emit \hyperlink{a00009_a3c84cf179d1746091795c60f3a68ce06}{statusBar}(\textcolor{stringliteral}{"Error opening file"});
...
00069         emit \hyperlink{a00009_a3c84cf179d1746091795c60f3a68ce06}{statusBar}(\textcolor{stringliteral}{"Error opening file"});
...
00079 
00080     \hyperlink{a00009_a6327eafc0dac189ec1b202d63ef32457}{\_mutex}.lock();
00081     \textcolor{keywordtype}{double} sep = 2; \textcolor{comment}{// 2cm of separation}
00082     QVector2D ori(12, 0);
00083     
00084     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; i < temp.size(); ++i) \{
00085         QVector2D aux(temp[i].X, temp[i].Y);
00086         aux -= ori;
00087         \textcolor{keywordtype}{int} steps = aux.length()/sep; 
00088       
00089         \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} j = 1; j <= steps; ++j)\{                
00090             Dominoe dAux(j*aux/\textcolor{keywordtype}{double}(steps) + ori, temp[i].ori);
00091             \hyperlink{a00009_ad06a87d9f22914fd2597c939a3eb61cd}{\_dominoe}[i].push\_back(dAux);         
00092         \}
00093     \}
00094     \hyperlink{a00009_a2b6ccfeacbb3cc9ac5c34549b9aa3f11}{\_dChanged} = \textcolor{keyword}{true};
00095     \hyperlink{a00009_a6327eafc0dac189ec1b202d63ef32457}{\_mutex}.unlock();
00096     
00097     f.close();
00098     
00099     emit \hyperlink{a00009_a3c84cf179d1746091795c60f3a68ce06}{statusBar}(\textcolor{stringliteral}{"File loaded succesfully"});
00100 \}
\end{DoxyCode}
...
\subsubsection[{reset}]{\setlength{\rightskip}{0pt plus 5cm}void Servo\+Thread\+::reset (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
...
00278                 \textcolor{keywordtype}{double} aux = abs(S[3].pos - angle);
00279                 \textcolor{keywordflow}{if} (aux < \hyperlink{a00009_a3ecb7da23afe91883435f239bd08ceb3}{maxErr}) \{
00280                     \hyperlink{a00009_a8d2299f41165bffe1656df776f7f7528}{\_status} = Status::going;
00281                     pas = 0;
00282                 \}
00283             \}
00284                 \textcolor{keywordflow}{break};
00285                 
00286             \textcolor{keywordflow}{case} Status::going:
00287                 
00288                 \textcolor{keywordflow}{break};
00289                 
00290             \textcolor{keywordflow}{case} Status::ending:
00291                 
00292                 \textcolor{keywordflow}{break};
00293             
00294             \textcolor{keywordflow}{default}:
00295                 \hyperlink{a00009_a8d2299f41165bffe1656df776f7f7528}{\_status} = Status::begin;
00296             
00297             \}
00298         \} 
00299         \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (\hyperlink{a00009_acdecea1688594d3ab7386a6db97dd90d}{\_mod} == Mode::Reset) \{
00300             \hyperlink{a00009_acdecea1688594d3ab7386a6db97dd90d}{\_mod} = Mode::Manual;
00301             pos = QVector3D(0, 0, -20);
00302             dom = 0;
00303         \}
00304         
00305         this->\hyperlink{a00009_a2b9f97473d19a7defaed3451bc830f79}{setAngles}(pos.toVector3D(), D);
00306         \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; i < 3; ++i) A[i].setGoalPosition(D[i]);
...
00311 \}
\end{DoxyCode}
\hypertarget{a00009_a2b9f97473d19a7defaed3451bc830f79}{}\index{Servo\+Thread@{Servo\+Thread}!set\+Angles@{set\+Angles}}
...
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [private]}}\label{a00009_a2b9f97473d19a7defaed3451bc830f79}
...
\begin{DoxyCode}
00314 \{    
00315     \textcolor{keywordtype}{double} x1 = pos.x() + \hyperlink{a00009_a3d51c16b1f498b48a6ecbfaadaba6ed2}{L2} - \hyperlink{a00009_a6281142e50115dd8c914c14cfae6f90d}{L1};
00316     \textcolor{keywordtype}{double} y1 = pos.z();
00317     \textcolor{keywordtype}{double} z1 = pos.y();
00318     D[0] = \hyperlink{a00009_add4637d917a772c4c01a43b5b66da2be}{singleAngle}(x1,y1,z1);
00319     
00320     \textcolor{keywordtype}{double} x2 = pos.y()*\hyperlink{a00009_aaa3e2dd194949b12f8a41ebd0d62fde9}{sin60} - pos.x()*\hyperlink{a00009_a86dc58ff23326f939cd6fb610ac90d53}{cos60} + \hyperlink{a00009_a3d51c16b1f498b48a6ecbfaadaba6ed2}{L2} - \hyperlink{a00009_a6281142e50115dd8c914c14cfae6f90d}{L1};
00321     \textcolor{keywordtype}{double} y2 = pos.z();
00322     \textcolor{keywordtype}{double} z2 = -pos.y()*\hyperlink{a00009_a86dc58ff23326f939cd6fb610ac90d53}{cos60} - pos.x()*\hyperlink{a00009_aaa3e2dd194949b12f8a41ebd0d62fde9}{sin60};
00323     D[1] = \hyperlink{a00009_add4637d917a772c4c01a43b5b66da2be}{singleAngle}(x2,y2,z2);
00324     
00325     \textcolor{keywordtype}{double} x3 = -pos.y()*\hyperlink{a00009_aaa3e2dd194949b12f8a41ebd0d62fde9}{sin60} - pos.x()*\hyperlink{a00009_a86dc58ff23326f939cd6fb610ac90d53}{cos60} + \hyperlink{a00009_a3d51c16b1f498b48a6ecbfaadaba6ed2}{L2} - \hyperlink{a00009_a6281142e50115dd8c914c14cfae6f90d}{L1};
00326     \textcolor{keywordtype}{double} y3 = pos.z();
00327     \textcolor{keywordtype}{double} z3 = -pos.y()*\hyperlink{a00009_a86dc58ff23326f939cd6fb610ac90d53}{cos60} + pos.x()*\hyperlink{a00009_aaa3e2dd194949b12f8a41ebd0d62fde9}{sin60};
00328     D[2] = \hyperlink{a00009_add4637d917a772c4c01a43b5b66da2be}{singleAngle}(x3,y3,z3);
00329     
00330     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{double} &d : D) d = 240 + d*180/M\_PI;
00331 \}
\end{DoxyCode}
...
\begin{DoxyCode}
00103 \{
00104     \hyperlink{a00009_a6327eafc0dac189ec1b202d63ef32457}{\_mutex}.lock();
00105     \textcolor{comment}{// Copying the joystick values}
00106     \hyperlink{a00009_a4ddc59272c23925f921e20ee630804c2}{\_axis} = QVector4D(aV[0], aV[1], aV[2], aV[3]);
00107     \hyperlink{a00009_a4ddc59272c23925f921e20ee630804c2}{\_axis}.normalize();
00108     \hyperlink{a00009_a6f956f7e0f2953e213ff95fb64857ab0}{\_buts} = buts;    
00109     \hyperlink{a00009_a6327eafc0dac189ec1b202d63ef32457}{\_mutex}.unlock();
00110 \}
\end{DoxyCode}
...
\subsubsection[{set\+Mode}]{\setlength{\rightskip}{0pt plus 5cm}void Servo\+Thread\+::set\+Mode (
\begin{DoxyParamCaption}
\item[{{\bf Mode}}]{m}
\end{DoxyParamCaption}
...
\begin{DoxyCode}
00334 \{
00335     \textcolor{keywordtype}{double} n = \hyperlink{a00009_a14f03febaa39a60b9bf7ff9b9151060c}{b}*\hyperlink{a00009_a14f03febaa39a60b9bf7ff9b9151060c}{b} - \hyperlink{a00009_a7dc3998d380d61406fe4485f9872edff}{a}*\hyperlink{a00009_a7dc3998d380d61406fe4485f9872edff}{a} - z0*z0 - x0*x0 - y0*y0;
00336     \textcolor{keywordtype}{double} raiz = sqrt (n*n*y0*y0 - 4*(x0*x0 + y0*y0)*(-x0*x0*\hyperlink{a00009_a7dc3998d380d61406fe4485f9872edff}{a}*\hyperlink{a00009_a7dc3998d380d61406fe4485f9872edff}{a} + n*n/4));
00337     
00338     \textcolor{keywordflow}{if} (x0 < 0) raiz *= -1;
00339     \textcolor{keywordtype}{double} y = (-n*y0 + raiz ) / (2*(x0*x0 + y0*y0));
00340     
00341     \textcolor{keywordtype}{int} signe = 1;
00342     \textcolor{keywordflow}{if} ((\hyperlink{a00009_a14f03febaa39a60b9bf7ff9b9151060c}{b}*\hyperlink{a00009_a14f03febaa39a60b9bf7ff9b9151060c}{b} - (y0 + \hyperlink{a00009_a7dc3998d380d61406fe4485f9872edff}{a})*(y0 + \hyperlink{a00009_a7dc3998d380d61406fe4485f9872edff}{a})) < (x0*x0 + z0*z0) && x0 < 0) signe *= -1;
00343     \textcolor{keywordtype}{double} x = sqrt(\hyperlink{a00009_a7dc3998d380d61406fe4485f9872edff}{a}*\hyperlink{a00009_a7dc3998d380d61406fe4485f9872edff}{a} - y*y)*signe;
00344     \textcolor{keywordflow}{return} atan2 (y,x);
00345 \}
\end{DoxyCode}
\hypertarget{a00009_a3c84cf179d1746091795c60f3a68ce06}{}\index{Servo\+Thread@{Servo\+Thread}!status\+Bar@{status\+Bar}}
...
\item[{Q\+String}]{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [signal]}}\label{a00009_a3c84cf179d1746091795c60f3a68ce06}
...
\begin{DoxyCode}
00113 \{
00114     \textcolor{comment}{// Opening file for writing}
00115     QFile f(file);
00116     f.open(QIODevice::WriteOnly);
00117     QDataStream df(&f);
00118     
00119     \hyperlink{a00009_a6327eafc0dac189ec1b202d63ef32457}{\_mutex}.lock();
00120     
00121     \textcolor{comment}{// Clamp and servos baud rate and port must be writen}
00122     df << int(Version::v\_1\_0) << \hyperlink{a00009_a9fccfd415e2e55c8abef7fcc6535af30}{\_cBaud} << \hyperlink{a00009_ab52437b31a433c427a6c050f2b1cc959}{\_cPort} << \hyperlink{a00009_a5b9a41b9e271275b914affb0a845a2ee}{\_sBaud} << 
      \hyperlink{a00009_ac9a614aa1518efb49b0a06636bd1bdbf}{\_sPort} << \hyperlink{a00009_a2591c704c80518be7abb1698364cab5e}{\_sSpeed}
00123        << int(\hyperlink{a00009_acdecea1688594d3ab7386a6db97dd90d}{\_mod}) << \hyperlink{a00009_a1ac6662fe6d198b5971ae0ffa7ddfcfd}{\_servos}.size();    
00124     \textcolor{keywordflow}{for} (\textcolor{keyword}{const} Servo &s : \hyperlink{a00009_a1ac6662fe6d198b5971ae0ffa7ddfcfd}{\_servos}) df << s.ID;
00125     
00126     \hyperlink{a00009_a6327eafc0dac189ec1b202d63ef32457}{\_mutex}.unlock();
00127 \}
\end{DoxyCode}
...
\subsubsection[{\+\_\+mod}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Mode} Servo\+Thread\+::\+\_\+mod\hspace{0.3cm}{\ttfamily [private]}}\label{a00009_acdecea1688594d3ab7386a6db97dd90d}
...
\subsubsection[{\+\_\+status}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Status} Servo\+Thread\+::\+\_\+status\hspace{0.3cm}{\ttfamily [private]}}\label{a00009_a8d2299f41165bffe1656df776f7f7528}
...
\subsubsection[{a}]{\setlength{\rightskip}{0pt plus 5cm}const double Servo\+Thread\+::a = 17.\+233\hspace{0.3cm}{\ttfamily [private]}}\label{a00009_a7dc3998d380d61406fe4485f9872edff}
...
\subsubsection[{b}]{\setlength{\rightskip}{0pt plus 5cm}const double Servo\+Thread\+::b = 22.\+648\hspace{0.3cm}{\ttfamily [private]}}\label{a00009_a14f03febaa39a60b9bf7ff9b9151060c}
...
\subsubsection[{cos60}]{\setlength{\rightskip}{0pt plus 5cm}const double Servo\+Thread\+::cos60 = 0.\+5\hspace{0.3cm}{\ttfamily [private]}}\label{a00009_a86dc58ff23326f939cd6fb610ac90d53}
...
\subsubsection[{L1}]{\setlength{\rightskip}{0pt plus 5cm}const double Servo\+Thread\+::\+L1 = 6.\+374\hspace{0.3cm}{\ttfamily [private]}}\label{a00009_a6281142e50115dd8c914c14cfae6f90d}
...
\subsubsection[{L2}]{\setlength{\rightskip}{0pt plus 5cm}const double Servo\+Thread\+::\+L2 = 6.\+000\hspace{0.3cm}{\ttfamily [private]}}\label{a00009_a3d51c16b1f498b48a6ecbfaadaba6ed2}
...
\subsubsection[{max\+Angle}]{\setlength{\rightskip}{0pt plus 5cm}const double Servo\+Thread\+::max\+Angle = 240.\+0\hspace{0.3cm}{\ttfamily [private]}}\label{a00009_a77cc2aed4eff12967e346cb64f6be192}
...
\subsubsection[{max\+Err}]{\setlength{\rightskip}{0pt plus 5cm}const double Servo\+Thread\+::max\+Err = 3.\+0\hspace{0.3cm}{\ttfamily [private]}}\label{a00009_a3ecb7da23afe91883435f239bd08ceb3}
...
\subsubsection[{min\+Angle}]{\setlength{\rightskip}{0pt plus 5cm}const double Servo\+Thread\+::min\+Angle = 60.\+0\hspace{0.3cm}{\ttfamily [private]}}\label{a00009_a9af4e0214b1b5c64978bbef49cde6d3c}


Minimum servo angle. 

\hypertarget{a00009_a22328f2a08b4a154a275242ee185aebf}{}\index{Servo\+Thread@{Servo\+Thread}!pos\+Idle@{pos\+Idle}}
...
\hypertarget{a00009_a232fd9d19e8f1be1d42b5801460137c6}{}\index{Servo\+Thread@{Servo\+Thread}!pos\+Start@{pos\+Start}}
\index{pos\+Start@{pos\+Start}!Servo\+Thread@{Servo\+Thread}}
\subsubsection[{pos\+Start}]{\setlength{\rightskip}{0pt plus 5cm}Q\+Vector4\+D Servo\+Thread\+::pos\+Start = Q\+Vector4\+D(11.\+5, 0.\+0f, -\/20, 150)\hspace{0.3cm}{\ttfamily [private]}}\label{a00009_a232fd9d19e8f1be1d42b5801460137c6}
...
\hypertarget{a00009_a86b38e336a177d6dd31401af98b07172}{}\index{Servo\+Thread@{Servo\+Thread}!work\+Heigh@{work\+Heigh}}
\index{work\+Heigh@{work\+Heigh}!Servo\+Thread@{Servo\+Thread}}
\subsubsection[{work\+Heigh}]{\setlength{\rightskip}{0pt plus 5cm}double Servo\+Thread\+::work\+Heigh = -\/25.\+0\hspace{0.3cm}{\ttfamily [private]}}\label{a00009_a86b38e336a177d6dd31401af98b07172}
...
\subsubsection[{work\+Rad\+Sq}]{\setlength{\rightskip}{0pt plus 5cm}const double Servo\+Thread\+::work\+Rad\+Sq = 144.\+0\hspace{0.3cm}{\ttfamily [private]}}\label{a00009_a4b9e5de00a02c6f77e4308ed209f0cc0}
