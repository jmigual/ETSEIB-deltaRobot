...
\begin{DoxyCompactItemize}
\item 
Q\+Vector$<$ Q\+Label $\ast$ $>$ \hyperlink{class_main_window_a30c99d7a544f74b0650758e5cc7ead5a}{\+\_\+axis}
\begin{DoxyCompactList}\small\item\em Handles all the axis labels. \end{DoxyCompactList}\item 
Q\+Vector$<$ float $>$ \hyperlink{class_main_window_a20f66f574ed4c96d8dfc0013e1095f15}{\+\_\+axis\+V}
\begin{DoxyCompactList}\small\item\em Contains the axis value;. \end{DoxyCompactList}\item 
Q\+Vector$<$ Q\+Label $\ast$ $>$ \hyperlink{class_main_window_a8eaf474e1b8672f32873ed009e28ce8a}{\+\_\+buts}
\begin{DoxyCompactList}\small\item\em Handles all the button labels. \end{DoxyCompactList}\item 
Q\+Vector$<$ bool $>$ \hyperlink{class_main_window_a519ae4630572cb63fbd04bce12fe8e77}{\+\_\+buts\+V}
\begin{DoxyCompactList}\small\item\em Handles all buttons values. \end{DoxyCompactList}\item 
Q\+String \hyperlink{class_main_window_aaccbe653019df03668429890e325ac21}{\+\_\+data\+P}
\begin{DoxyCompactList}\small\item\em Contains the path to the data location. \end{DoxyCompactList}\item 
int \hyperlink{class_main_window_a282d4090e96c676578c4336391b1af08}{\+\_\+j\+Axis\+X} = -\/1
\begin{DoxyCompactList}\small\item\em Axis for the X value. \end{DoxyCompactList}\item 
int \hyperlink{class_main_window_aaaced09ce813bbcac92047f5ef39f182}{\+\_\+j\+Axis\+Y} = -\/1
\begin{DoxyCompactList}\small\item\em Axis for the Y value. \end{DoxyCompactList}\item 
int \hyperlink{class_main_window_a18cc17eff4ff04ee0aae07c609e82d33}{\+\_\+j\+Axis\+Z} = -\/1
\begin{DoxyCompactList}\small\item\em A\+Xis for the Z value. \end{DoxyCompactList}\item 
X\+Joystick \hyperlink{class_main_window_a671f35800890e518713e1946671d8730}{\+\_\+joy}
\begin{DoxyCompactList}\small\item\em To handle the joystick. \end{DoxyCompactList}\item 
\hyperlink{class_servo_thread}{Servo\+Thread} \hyperlink{class_main_window_a97f8ecc7ecb930b796178cef7b975013}{\+\_\+s\+T}
...
Q\+Timer \hyperlink{class_main_window_a254b03b878cfda75c1c411a2f8568d33}{\+\_\+timer}
...
\begin{DoxyCompactItemize}
\item 
static const int \hyperlink{class_main_window_a646727b1c45c72638325adfd460649c0}{s\+Count} = 3
\begin{DoxyCompactList}\small\item\em Contains the number of minimun servos to work. \end{DoxyCompactList}\item 
static const int \hyperlink{class_main_window_a42c44af9c0eebc33f4e81f02e15b0461}{a\+S\+Count} = 0
...
00036     \}
00037     \hyperlink{class_main_window_a35466a70ed47252a0191168126a352a5}{ui}->joyAxis->setLayout(wL);
00038     
...
00042         \hyperlink{class_main_window_a8eaf474e1b8672f32873ed009e28ce8a}{\_buts}[i] = \textcolor{keyword}{new} QLabel(QString::number(i + 1));
00043         wL->addWidget(\hyperlink{class_main_window_a8eaf474e1b8672f32873ed009e28ce8a}{\_buts}[i], i/8, i%8);
00044         \hyperlink{class_main_window_a8eaf474e1b8672f32873ed009e28ce8a}{\_buts}[i]->setEnabled(\textcolor{keyword}{false});
00045         \hyperlink{class_main_window_a8eaf474e1b8672f32873ed009e28ce8a}{\_buts}[i]->hide();
00046     \}
00047     \hyperlink{class_main_window_a35466a70ed47252a0191168126a352a5}{ui}->joyButs->setLayout(wL);
00048     \hyperlink{class_main_window_a35466a70ed47252a0191168126a352a5}{ui}->joyAxis->hide();
00049     \hyperlink{class_main_window_a35466a70ed47252a0191168126a352a5}{ui}->joyButs->hide();
00050     \hyperlink{class_main_window_a35466a70ed47252a0191168126a352a5}{ui}->line->hide();
00051     
00052     
00053     \textcolor{comment}{// Creating data Path    }
00054     \hyperlink{class_main_window_aaccbe653019df03668429890e325ac21}{\_dataP} = QStandardPaths::writableLocation(QStandardPaths::AppDataLocation);
00055     QDir dir(\hyperlink{class_main_window_aaccbe653019df03668429890e325ac21}{\_dataP});
00056     \textcolor{keywordflow}{if} (!dir.exists()) dir.mkpath(\hyperlink{class_main_window_aaccbe653019df03668429890e325ac21}{\_dataP});
00057 \}
\end{DoxyCode}
...
\begin{DoxyCode}
00060 \{
00061     \textcolor{keyword}{delete} \hyperlink{class_main_window_a35466a70ed47252a0191168126a352a5}{ui};
00062 \}
\end{DoxyCode}


\subsection{Member Function Documentation}
\hypertarget{class_main_window_abb4c2d8a79c9f80010ea031366bf8226}{}\index{Main\+Window@{Main\+Window}!joy\+Changed@{joy\+Changed}}
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [private]}, {\ttfamily [slot]}}\label{class_main_window_abb4c2d8a79c9f80010ea031366bf8226}
...
\begin{DoxyCode}
00065 \{
00066     \textcolor{keywordtype}{int} sel = \hyperlink{class_main_window_a671f35800890e518713e1946671d8730}{\_joy}.current();
00067     
00068     QVector< XJoystick::Info > V(\hyperlink{class_main_window_a671f35800890e518713e1946671d8730}{\_joy}.available());
00069     \textcolor{keywordtype}{bool} found = \textcolor{keyword}{false};
00070     \textcolor{keywordtype}{int} i = 0;
00071     \textcolor{keywordflow}{while} (i < V.size() and not found) \{ found = V[i].ID == sel; ++i; \}
00072     \textcolor{keywordflow}{if} (not found) \{
00073         \textcolor{keywordflow}{if} (V.size() > 0) \{
00074             \hyperlink{class_main_window_a671f35800890e518713e1946671d8730}{\_joy}.select(V[0].ID);
00075             \hyperlink{class_main_window_a35466a70ed47252a0191168126a352a5}{ui}->line->hide();
00076             
00077             \textcolor{comment}{// Showing axis}
00078             \hyperlink{class_main_window_a35466a70ed47252a0191168126a352a5}{ui}->joyAxis->show();
00079             
00080             \textcolor{comment}{// Showing buttons}
00081             \textcolor{keywordflow}{for} (QLabel *l : \hyperlink{class_main_window_a8eaf474e1b8672f32873ed009e28ce8a}{\_buts}) l->hide();
00082             \hyperlink{class_main_window_a35466a70ed47252a0191168126a352a5}{ui}->joyButs->show();
00083             \textcolor{keywordtype}{int} n = \hyperlink{class_main_window_a671f35800890e518713e1946671d8730}{\_joy}.buttonCount();
00084             \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; i < n; ++i) \_buts[i]->show();
00085         \}
00086         \textcolor{keywordflow}{else} \{
00087             \hyperlink{class_main_window_a671f35800890e518713e1946671d8730}{\_joy}.select(-1);
00088             \hyperlink{class_main_window_a35466a70ed47252a0191168126a352a5}{ui}->joyAxis->hide();
00089             \hyperlink{class_main_window_a35466a70ed47252a0191168126a352a5}{ui}->joyButs->hide();
00090             \hyperlink{class_main_window_a35466a70ed47252a0191168126a352a5}{ui}->line->hide();
00091         \}
00092     \}
00093     emit \hyperlink{class_main_window_ac85ba5aec3be2a51a348ff669b9dc842}{joystickChanged}();
00094 \}
\end{DoxyCode}
\hypertarget{class_main_window_ac85ba5aec3be2a51a348ff669b9dc842}{}\index{Main\+Window@{Main\+Window}!joystick\+Changed@{joystick\+Changed}}
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [signal]}}\label{class_main_window_ac85ba5aec3be2a51a348ff669b9dc842}
...
\begin{DoxyCode}
00098 \{
00099     \hyperlink{class_options_window}{OptionsWindow} o(\hyperlink{class_main_window_a671f35800890e518713e1946671d8730}{\_joy}, &\hyperlink{class_main_window_a97f8ecc7ecb930b796178cef7b975013}{\_sT}, \textcolor{keyword}{this});
00100     o.exec();
00101     
00102     connect(\textcolor{keyword}{this}, SIGNAL(\hyperlink{class_main_window_ac85ba5aec3be2a51a348ff669b9dc842}{joystickChanged}()), &o, SLOT(
      \hyperlink{class_main_window_ac85ba5aec3be2a51a348ff669b9dc842}{joystickChanged}()));
00103     
00104     \textcolor{keywordflow}{if} (o.result()) o.storeData();
00105 \}
\end{DoxyCode}
\hypertarget{class_main_window_ae66e9ab15f911b93fce0f161d2fde880}{}\index{Main\+Window@{Main\+Window}!on\+\_\+start\+\_\+clicked@{on\+\_\+start\+\_\+clicked}}
...
{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [private]}, {\ttfamily [slot]}}\label{class_main_window_ae66e9ab15f911b93fce0f161d2fde880}

\begin{DoxyCode}
00120 \{
00121     QString text = \hyperlink{class_main_window_a35466a70ed47252a0191168126a352a5}{ui}->start->text();
00122     
00123     \textcolor{keywordflow}{if} (text == \textcolor{stringliteral}{"Start"}) \{
00124         \hyperlink{class_main_window_a97f8ecc7ecb930b796178cef7b975013}{\_sT}.\hyperlink{class_servo_thread_a5f32574f843d76deffec45995028389b}{wakeUp}();
00125         \hyperlink{class_main_window_a35466a70ed47252a0191168126a352a5}{ui}->start->setText(\textcolor{stringliteral}{"Stop"});
00126     \}
00127     \textcolor{keywordflow}{else} \textcolor{keywordflow}{if} (text == \textcolor{stringliteral}{"Stop"}) \{
00128         \hyperlink{class_main_window_a97f8ecc7ecb930b796178cef7b975013}{\_sT}.\hyperlink{class_servo_thread_ae0d4a59954aafbe8cd85f9326e4fcdd0}{pause}();
00129         \hyperlink{class_main_window_a35466a70ed47252a0191168126a352a5}{ui}->start->setText(\textcolor{stringliteral}{"Start"});
00130     \}
00131 \}
\end{DoxyCode}
...
\begin{DoxyCode}
00108 \{
00109     \hyperlink{class_main_window_a671f35800890e518713e1946671d8730}{\_joy}.update();
00110     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; i < XJoystick::AxisCount; ++i) \hyperlink{class_main_window_a20f66f574ed4c96d8dfc0013e1095f15}{\_axisV}[i] = \hyperlink{class_main_window_a671f35800890e518713e1946671d8730}{\_joy}[i];
00111     \textcolor{keywordflow}{for} (\textcolor{keywordtype}{int} i = 0; i < XJoystick::ButtonCount; ++i) \hyperlink{class_main_window_a519ae4630572cb63fbd04bce12fe8e77}{\_butsV}[i] = \hyperlink{class_main_window_a671f35800890e518713e1946671d8730}{\_joy}.button(i);
00112     
00113     \hyperlink{class_main_window_a97f8ecc7ecb930b796178cef7b975013}{\_sT}.\hyperlink{class_servo_thread_a8497ea56991b620981ce1fbf53d9ebdb}{setData}(\hyperlink{class_main_window_a20f66f574ed4c96d8dfc0013e1095f15}{\_axisV}, \hyperlink{class_main_window_a519ae4630572cb63fbd04bce12fe8e77}{\_butsV});
00114     QVector<ServoThread::Servo> servo(\hyperlink{class_main_window_a97f8ecc7ecb930b796178cef7b975013}{\_sT}.\hyperlink{class_servo_thread_a5fd8ef13314428f5ba7646730cc58f1c}{getServosInfo}());
00115     
00116     \textcolor{comment}{// TODO: Finish update function}
00117 \}
\end{DoxyCode}


\subsection{Member Data Documentation}
\hypertarget{class_main_window_a30c99d7a544f74b0650758e5cc7ead5a}{}\index{Main\+Window@{Main\+Window}!\+\_\+axis@{\+\_\+axis}}
...
\hypertarget{class_main_window_a20f66f574ed4c96d8dfc0013e1095f15}{}\index{Main\+Window@{Main\+Window}!\+\_\+axis\+V@{\+\_\+axis\+V}}
...
\hypertarget{class_main_window_a8eaf474e1b8672f32873ed009e28ce8a}{}\index{Main\+Window@{Main\+Window}!\+\_\+buts@{\+\_\+buts}}
...
\hypertarget{class_main_window_a519ae4630572cb63fbd04bce12fe8e77}{}\index{Main\+Window@{Main\+Window}!\+\_\+buts\+V@{\+\_\+buts\+V}}
...
\hypertarget{class_main_window_aaccbe653019df03668429890e325ac21}{}\index{Main\+Window@{Main\+Window}!\+\_\+data\+P@{\+\_\+data\+P}}
...
\hypertarget{class_main_window_a282d4090e96c676578c4336391b1af08}{}\index{Main\+Window@{Main\+Window}!\+\_\+j\+Axis\+X@{\+\_\+j\+Axis\+X}}
...
\hypertarget{class_main_window_aaaced09ce813bbcac92047f5ef39f182}{}\index{Main\+Window@{Main\+Window}!\+\_\+j\+Axis\+Y@{\+\_\+j\+Axis\+Y}}
...
\hypertarget{class_main_window_a18cc17eff4ff04ee0aae07c609e82d33}{}\index{Main\+Window@{Main\+Window}!\+\_\+j\+Axis\+Z@{\+\_\+j\+Axis\+Z}}
...
\hypertarget{class_main_window_a671f35800890e518713e1946671d8730}{}\index{Main\+Window@{Main\+Window}!\+\_\+joy@{\+\_\+joy}}
...
\hypertarget{class_main_window_a97f8ecc7ecb930b796178cef7b975013}{}\index{Main\+Window@{Main\+Window}!\+\_\+s\+T@{\+\_\+s\+T}}
\index{\+\_\+s\+T@{\+\_\+s\+T}!Main\+Window@{Main\+Window}}
\subsubsection[{\+\_\+s\+T}]{\setlength{\rightskip}{0pt plus 5cm}{\bf Servo\+Thread} Main\+Window\+::\+\_\+s\+T\hspace{0.3cm}{\ttfamily [private]}}\label{class_main_window_a97f8ecc7ecb930b796178cef7b975013}


Contains the thread controlling all the servos and external hardware. 

\hypertarget{class_main_window_a254b03b878cfda75c1c411a2f8568d33}{}\index{Main\+Window@{Main\+Window}!\+\_\+timer@{\+\_\+timer}}
...
\hypertarget{class_main_window_a42c44af9c0eebc33f4e81f02e15b0461}{}\index{Main\+Window@{Main\+Window}!a\+S\+Count@{a\+S\+Count}}
...
\hypertarget{class_main_window_a646727b1c45c72638325adfd460649c0}{}\index{Main\+Window@{Main\+Window}!s\+Count@{s\+Count}}
